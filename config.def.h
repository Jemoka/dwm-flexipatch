...
static const char *altbarcmd             = "/home/hliu/.config/polybar/bar.sh"; /* Alternate bar launch command */
...
static const char *dmenucmd[] = {
	"/home/hliu/.config/scripts/dmenu_path.sh",
	#if !NODMENU_PATCH
	"-m", dmenumon,
	#endif // NODMENU_PATCH
	"-fn", dmenufont,
...
static Key keys[] = {
	...
	{ MODKEY|ControlMask|Mod4Mask,  XK_s,          setscratch,             {.ui = 0 } },
    { MODKEY|ControlMask|Mod4Mask,  XK_r,          removescratch,          {.ui = 0 } },
	#endif // SCRATCHPADS_PATCH
